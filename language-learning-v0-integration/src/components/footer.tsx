        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/recommendation" className="text-gray-400 hover:text-white transition-colors">AI推荐</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/languages" className="text-gray-400 hover:text-white transition-colors">语言列表</Link></li>
